$(document).ready(function() {
    ...
    var imageArray = ["<img class='center-block img-right' src='assets/images/leia.jpg'>", "<img class='center-block img-right' src='assets/images/Falcon.jpg'>", "<img class='center-block img-right' src='assets/images/hothwallpaper.jpg'>", "<img class='center-block img-right' src='img/japan.png'>", "<img class='center-block img-right' src='img/china.png'>", "<img class='center-block img-right' src='img/turkey.png'>", "<img class='center-block img-right' src='img/colombia.png'>", "<img class='center-block img-right' src='img/india.png'>"];
